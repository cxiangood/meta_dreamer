#!/bin/bash
#SBATCH --job-name=p4_eval_cnn_p3
#SBATCH --comment="P4 eval: CNN P3 v2 (step6000) on loc1+loc3"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4_eval_cnn_p3_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4_eval_cnn_p3_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4_eval_cnn_p3
mkdir -p "$OUTDIR"

echo "=== P4 Eval: CNN P3 v2 (step6000) ==="
