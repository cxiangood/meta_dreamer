#!/bin/bash
#SBATCH --job-name=p4eval_base
#SBATCH --comment="P4 Eval: Baseline WM + BC actor (2000-step)"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4eval_base_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4eval_base_%j.err
...
WM_CKPT=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/df_traj_base/checkpoint_step8000.pt
BC_CKPT=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/bc_traj_base/checkpoint_bc_final.pt
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4eval_base
mkdir -p "$OUTDIR"

echo "=== P4 Eval: Baseline WM + BC (2000-step) ==="
echo "WM: $WM_CKPT"
echo "AC: $BC_CKPT"
echo "Start: $(date)"
