...
class BEVEncoder(nn.Module):
    """
    Encodes BEV semantic map (6 channels, 256x256) into a compact feature vector.

    Architecture:
    - 4 conv layers with increasing depth [64, 128, 256, 512]
    - Each: Conv3x3, stride=2, SiLU, RMSNorm
