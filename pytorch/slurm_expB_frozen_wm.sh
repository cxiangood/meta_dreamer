#!/bin/bash
#SBATCH --job-name=expB_fwm
#SBATCH --comment="Exp B: frozen WM (only AC trains)"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expB_fwm_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expB_fwm_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expB_frozen_wm
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Exp B: Frozen WM — only AC learns, continue/phase heads stay calibrated ==="
echo "WM: $WM_CKPT"
