...
#SBATCH --comment="DF+SIGReg Phase2: Decoder-Free + Barlow + SIGReg (OUR FULL METHOD)"
...
echo "DF+SIGReg: Decoder-Free + Barlow Twins + SIGReg on continuous states (FULL)"
echo "Start: $(date)"
echo "=========================================="
...
python -u main.py \
    ...
    --logdir /share/home/u23516/code/meta_dreamer-main/pytorch/logs/df_sigreg_p2 \
    --bev-size 300 \
    --batch-size 32 \
    --total-steps 500000 \
    --sigreg-lambda 0.1 \
    --wandb-run-name df_sigreg_p2_s42 \
    --preload \
    --seed 42
