#!/bin/bash
#SBATCH --job-name=expA_nact
#SBATCH --comment="Exp A: pure phase-progress reward (no action bonus)"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expA_noact_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expA_noact_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expA_no_action_bonus
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Exp A: No action bonus — pure phase-progress reward ==="
echo "WM: $WM_CKPT"
...
python -u train_online_dreamer_v2.py \
    ...
    --video-every 10 \
    --save-every 50 \
    --wandb-run-name expA_no_action_bonus
