#!/bin/bash
#SBATCH --job-name=p4_eval_df_p3
#SBATCH --comment="P4 eval: DF+SIG P3 v2 (step4000) on loc1+loc3"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4_eval_df_p3_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4_eval_df_p3_%j.err
...
CKPT=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/df_sig_p3/checkpoint_latest.pt
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4_eval_df_p3
mkdir -p "$OUTDIR"

echo "=== P4 Eval: DF+SIG P3 v2 (step4000) ==="
