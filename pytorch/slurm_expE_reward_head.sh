#!/bin/bash
#SBATCH --job-name=expE_rew
#SBATCH --comment="Exp E: reward_head primary + phase bonus + residual actions + action L2"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expE_rew_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expE_rew_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expE_reward_head
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Exp E: reward_head primary + phase bonus + residual actions + action L2 ==="
echo "WM: $WM_CKPT"
...
python -u train_online_dreamer_v2.py \
    ...
    --video-every 10 \
    --save-every 50 \
    --wandb-run-name expE_reward_head
