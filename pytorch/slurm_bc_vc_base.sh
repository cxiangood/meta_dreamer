#!/bin/bash
#SBATCH --job-name=bc_vc_base
#SBATCH --comment="BC 8000 Baseline (no phase) on Veh+Curv WM (step6000)."
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/bc_vc_base_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/bc_vc_base_%j.err
...
echo "=== BC 8000 Baseline: Veh+Curv WM step6000 ==="
echo "Start: $(date)"
...
python -u main.py \
    ...
    --logdir /share/home/u23516/code/meta_dreamer-main/pytorch/logs/bc_vc_base \
    --bev-size 300 \
    --bev-downsample cnn \
    --cnn-factor 2 \
    --batch-size 16 \
