#!/bin/bash
#SBATCH --job-name=reswm_1t
#SBATCH --comment="ResWM residual actions: loc6_rec79_t97, 1000ep, action_bonus imagination"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_reswm_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_reswm_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_reswm
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR/videos"

echo "=== ResWM (residual actions ON): loc6_rec79_t97 merge_idx=59, 1000 episodes ==="
echo "WM: $WM_CKPT (offline P2, frozen phase_head)"
echo "Actor: residual_action=True (action = tanh(prev_a + outscale*Δ))"
echo "Start: $(date)"
