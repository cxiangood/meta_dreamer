#!/bin/bash
#SBATCH --job-name=phase_moe
#SBATCH --comment="Phase MoE: 3 actors + phase routing + phase-only imagination + vehicle-aware reward"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_moe_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_moe_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_moe
mkdir -p "$OUTDIR"

echo "=== Phase MoE: 3 actors + phase routing + phase-only imagination + vehicle reward ==="
echo "WM: $WM_CKPT"
echo "Start: $(date)"
...
python -u train_online_dreamer_v2.py \
    ...
    --save-every 50 \
    --phase-actors \
    --wandb-run-name online_phase_moe
