#!/bin/bash
#SBATCH --job-name=expD_fna
#SBATCH --comment="Exp D: frozen WM + no action bonus (combined)"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expD_fna_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expD_fna_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expD_frozen_noact
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Exp D: Frozen WM + No action bonus — pure phase reward, calibrated heads ==="
echo "WM: $WM_CKPT"
...
python -u train_online_dreamer_v2.py \
    ...
    --video-every 10 \
    --save-every 50 \
    --wandb-run-name expD_frozen_noact
