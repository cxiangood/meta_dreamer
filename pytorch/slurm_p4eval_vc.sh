#!/bin/bash
#SBATCH --job-name=p4eval_vc
#SBATCH --comment="P4 Eval: Veh+Curv WM + BC actor (2000-step)"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4eval_vc_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4eval_vc_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/p4eval_vc
mkdir -p "$OUTDIR"

echo "=== P4 Eval: Veh+Curv WM + BC (2000-step) ==="
echo "WM: $WM_CKPT"
echo "AC: $BC_CKPT"
echo "Start: $(date)"
