#!/bin/bash
#SBATCH --job-name=dbg_zeroact
#SBATCH --comment="Debug zero-action bug: 15ep with per-step debug logging"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/dbg_zeroact_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/dbg_zeroact_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/dbg_zeroact
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Debug zero-action: 15 episodes ==="
echo "WM: $WM_CKPT"
echo "Start: $(date)"
