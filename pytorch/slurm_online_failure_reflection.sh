#!/bin/bash
#SBATCH --job-name=fail_refl
#SBATCH --comment="Phase-only imagination + failure state replay + negative margin + per-phase vehicle reward"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_fr_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_fr_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_fr
mkdir -p "$OUTDIR"

echo "=== Failure Reflection: phase-only imagination + crash replay + vehicle-aware reward ==="
echo "WM: $WM_CKPT"
echo "Start: $(date)"
...
python -u train_online_dreamer_v2.py \
    ...
    --save-every 50 \
    --failure-reflection \
    --wandb-run-name online_failure_reflection
