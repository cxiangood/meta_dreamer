#!/bin/bash
#SBATCH --job-name=expE_rev2
#SBATCH --comment="Exp E v2: residual actions + phase reward + experience replay + action L2"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expE_v2_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expE_v2_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expE_v2_replay
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Exp E v2: residual + phase reward + 经验回放 (real env rewards) + action L2 ==="
echo "WM: $WM_CKPT"
