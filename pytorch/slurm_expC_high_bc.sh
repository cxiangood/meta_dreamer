#!/bin/bash
#SBATCH --job-name=expC_hbc
#SBATCH --comment="Exp C: high BC anchor weight (0.3)"
...
#SBATCH --mem=64G
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expC_hbc_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expC_hbc_%j.err
...
OUTDIR=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/expC_high_bc_anchor
VIDEO_DIR="$OUTDIR/videos_train"
SEL_JSON="$OUTDIR/single_track.json"
mkdir -p "$OUTDIR" "$VIDEO_DIR"

echo "=== Exp C: High BC anchor weight (0.3) — strong pull toward PID actions ==="
echo "WM: $WM_CKPT"
...
python -u train_online_dreamer_v2.py \
    ...
    --video-every 10 \
    --save-every 50 \
    --wandb-run-name expC_high_bc_anchor
