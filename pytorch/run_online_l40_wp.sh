...
#SBATCH --mem=64G
#SBATCH --job-name=online_wp
#SBATCH --output=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_wp_%j.out
#SBATCH --error=/share/home/u23516/code/meta_dreamer-main/pytorch/logs/online_wp_%j.err
...
exec python -u train_online_dreamer_v2.py \
    ...
    --bc-weight 0.5 \
    --use-waypoint \
    --waypoint-offsets 1,2,5 \
    --video-dir logs/online_videos \
    --logdir logs/online_v2 \
    --save-every 50 \
    --wandb-run-name online_dreamer_v2_wp
