...
def make_env(config, index, **overrides):
  ...
  ctor = {
      ...
      'carla0915': 'embodied.envs.carla0915:Carla0915Env',
  ...
  # 针对 carla0915 环境只传 **kwargs，不传 task，避免参数冲突
  if suite == 'carla0915' and hasattr(ctor, '__name__') and 'Carla0915' in ctor.__name__:
    env = ctor(**kwargs)
  else:
